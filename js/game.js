    ...
    if (!this.firstPick || this.secondPick) {
      ...
      if (this.firstPick.title === tile.title) {
        ...
        if(this.unmatchedPairs == 0) {
          $('.message span').html('恭喜你贏了!獲得<a href="https://www.facebook.com/photo.php?fbid=1486731391555517&set=a.1478822712346385.1073741828.1478815515680438&type=1&stream_ref=10" target="_blank" style="color:yellow">偉忠抱枕乙個</a>!腫花民國萬歲!');
          // $('#bgsong').html('<iframe width="350" height="263" src="//www.youtube.com/embed/N-p3ZiNZ6WM?autoplay=1&loop=1&playlist=N-p3ZiNZ6WM&rel=0" frameborder="0" allowfullscreen></iframe>');
...
Game.MESSAGE_CLICK = '來來來翻一張，看看偉忠泳褲後面是什麼';
Game.MESSAGE_ONE_MORE = '來來來，再看看另一條小褲褲～'
Game.MESSAGE_MISS = '可惜RRR，再選錯偉忠要噴汁了！';
